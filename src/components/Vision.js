    ...
    return (
        <section class="bg-gray-800 h-full">
            <div class="py-8 px-4 mx-auto max-w-screen-xl md:text-center lg:py-16 lg:px-12">
                ...
                <h1 class="mb-4 mt-5 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl dark:text-white">Our vision/mission</h1>
                <p className='font-bold mt-10 text-white'>Vision</p>
                ...
                <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    <Link to="/values" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                        Our Values
