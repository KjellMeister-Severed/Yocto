                    ...
                    <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                        <div className="w-full relative flex items-center justify-between h-16">
                            ...
                            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                                <div className="flex-shrink-0 flex font-bold text-white text-xl items-center">
                                    <span className='opacity-70'>Y</span>octo<span className='opacity-70'>C</span>onsult
                                </div>
                            </div>
