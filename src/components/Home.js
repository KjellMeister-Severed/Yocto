    ...
    return (
        <section class="bg-gray-800 h-full">
            <div class="py-8 px-4 mx-auto max-w-screen-xl md:text-center lg:py-16 lg:px-12">
                ...
                <h1 class="mb-4 mt-5 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl dark:text-white">Detailed organizational advice</h1>
                <p class="mb-8 text-lg font-normal text-gray-400 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Helping in detail, organisations and individuals
                    to create and sustain
                    competitive advantage in business development.</p>
